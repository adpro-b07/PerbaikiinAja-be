...
public class ReportServiceImpl implements ReportService {
    ...
    public Report createReport(String ulasan, int rating, long idPesanan) {
        ...
        Report existingReport = reportRepository.findByPesananId(idPesanan);
    ...
    public Report updateReport(long idPesanan, String ulasan, int rating) {
        Report report = reportRepository.findByPesananId(idPesanan);
        if (report == null) {
            throw new RuntimeException("Report not found with ID: " + idPesanan);
        }
    ...
    public Report getReportByPesananId(long pesananId) {
        Report report = reportRepository.findByPesananId(pesananId);
        if (report == null) {
    ...
    public List<Report> getReportsByTeknisi(String emailTeknisi) {
        return reportRepository.findByTeknisi(emailTeknisi);
    }

    @Override
    public List<Report> getReportsByPengguna(String emailPengguna) {
        return reportRepository.findByPengguna(emailPengguna);
    }
